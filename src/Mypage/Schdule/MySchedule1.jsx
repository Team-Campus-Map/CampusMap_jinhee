        ...
        >
          ...
          <tr>
            ...
            <td
              rowspan={"3"}
              className="name_box2"
              onClick={this.EngineeringMath}
            >
              공학수학
            </td>
            <td rowspan={"2"} className="name_box3" onClick={this.English}>
              영어
            </td>
            <td></td>
          </tr>
          ...
          <tr>
            <th>11</th>
            <td className="name_box4" onClick={this.Christian}>
              기독교
            </td>
            <td></td>
            <td className="name_box5" onClick={this.chapel}>
              채플
            </td>
            <td></td>
          </tr>
          <tr>
            <th>12</th>
            <td></td>
            <td className="name_box6" onClick={this.lifephilosophy}>
              삶과 철학
            </td>
            <td></td>
            <td></td>
          ...
          <tr>
            <th>1</th>
            <td rowSpan={"3"} className="name_box7" onClick={this.Java}>
              자바스크립트
            </td>
            <td></td>
            <td rowSpan={"2"} className="name_box9" onClick={this.c}>
              c++
            </td>
            <td rowSpan={"2"} className="name_box10" onClick={this.Algorithm}>
              알고리즘
            </td>
            <td></td>
          </tr>
